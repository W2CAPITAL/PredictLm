...
const SOURCES=[
  ...
  ['hcengineering/platform','main','unverified','reference',['business-os','crm','project-management','hr','chat']],
  ['jtylek/EpesiCRM','master','unverified','reference',['crm','contacts','sales','activities']],
  ['vladandreevg/salesmancrm','main','unverified','reference',['crm','sales','pipeline']],
  ['trycompai/crm','main','MIT','reference',['crm','agents','evidence','followups','work-queue']],
  ['MasteraSnackin/CreatorHub','main','unverified','reference',['creator','content','analytics','video']],
  ['higgsfield-ai/higgsfield','main','unverified','reference',['gpu','training','orchestration','mlops']],
  ['JacobEvelyn/friends','main','unverified','reference',['relationship-crm','activities','reminders','notes']],
  ['Peppermint-Lab/peppermint','master','unverified','reference',['helpdesk','tickets','sla','notes','customers']],
  ['go2ismail/Free-CRM','main','unverified','reference',['crm','campaigns','leads','budgets','sales']],
