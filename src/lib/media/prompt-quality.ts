...
const qualityCore=[
  ...
  'preserve exact identity of every explicitly named character, product, brand or landmark',
  'canonical silhouette costume colors symbols and requested power form for named known subjects',
  'never replace a named character with a generic lookalike',
  'never fuse opposing named characters unless explicitly requested',
