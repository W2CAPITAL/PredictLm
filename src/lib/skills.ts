...
export const skills: SkillSpec[] = [
  ...
  { id:'agent-code', name:'Agentic Coding Patterns', category:'Build', description:'Recipes de execução, decomposição e revisão para agentes de código.', source:'tanbiralam/claude-code + Anil-matcha/Open-Generative-AI', runtime:'built-in' },
  ...
  { id:'bonsai', name:'Bonsai Local Vision', category:'AI', description:'Bridge experimental para geração/visão local quando disponível.', source:'PrismML-Eng/Bonsai-Image-Demo + PrismML-Eng/Bonsai-demo', runtime:'bridge' },
  { id:'heygen', name:'HeyGen Production', category:'Media', description:'Skills, CLI, avatar, launch-video, Hyperframes e recipes de produção.', source:'heygen-com/skills + heygen-com/heygen-cli + heygen-com/hyperframes-launch-video + heygen-com/hyperframes-launches + heygen-com/liveavatar-gpt-live-demos + 927tanmay/react-ai-voice-avatar + CementMerchant17/heygen + Ultimatesiquest/heygen-zen', runtime:'external' },
  { id:'davinci', name:'DaVinci Resolve MCP', category:'Media', description:'Bridge para edição e automação no DaVinci Resolve instalado localmente.', source:'hiteshK03/davinci-resolve-mcp + PanelActivistMatch38/Davinci-Resolve-Studio', runtime:'bridge' },
  { id:'cinema', name:'AI Cinema Studio', category:'Media', description:'Planejamento de cenas, shots, render, montagem e vídeo curto.', source:'poptechstudio/ai-cinema-studio-engine + ClipMakeAI/ClipMake.ai', runtime:'external' },
  ...
  { id:'midjourney', name:'Midjourney Automation Recipe', category:'Media', description:'Adapter opcional para filas externas de geração quando o usuário configurar seu próprio runtime.', source:'passivebot/midjourney-automation-bot', runtime:'external' },
