...
function crmApp(title:string,prompt:string=''){
  ...
  return [
    ...
    " const [leads,setLeads]=useState([{id:1,name:'Marina Costa',company:'Atlas Consultoria',status:'Novo',value:2400,mrr:490,owner:'Ana',last:'Hoje'},{id:2,name:'Rafael Lima',company:'Nova Capital',status:'Qualificado',value:8200,mrr:890,owner:'Davi',last:'Ontem'},{id:3,name:'Aline Rocha',company:'Orbit Labs',status:'Proposta',value:14900,mrr:1290,owner:'Ana',last:'2d'},{id:4,name:'Carlos Melo',company:'Melo & Co.',status:'Fechado',value:21900,mrr:1890,owner:'Davi',last:'4d'}]);",
    ...
    " const add=()=>{if(!name.trim())return;setLeads(x=>[{id:Date.now(),name:name.trim(),company:company.trim()||'Sem empresa',status:'Novo',value:0,mrr:0,owner:'Você',last:'Agora'},...x]);setName('');setCompany('')};",
