...
import { AppLearningObserver } from '@/components/AppLearningObserver';
...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="pt-BR"><body><NeuralWarmup/><AppLearningObserver/>{children}</body></html>}
