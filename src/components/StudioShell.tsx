...
import { Bot, Box, Brain, Browser, ChevronDown, Code2, Download, FileCode2, Film, FolderTree, Globe2, Hammer, Layers3, MemoryStick, PanelLeft, Play, Plug, RotateCcw, Search, Send, Settings2, ShieldCheck, Sparkles, TerminalSquare, WandSparkles } from 'lucide-react';
...
const panels: {id:PanelId;label:string;icon:any}[] = [
  {id:'agent',label:'Agent',icon:Bot},{id:'explorer',label:'Files',icon:FolderTree},{id:'browser',label:'Browser',icon:Browser},{id:'skills',label:'Skills',icon:Sparkles},{id:'memory',label:'Memory',icon:Brain},{id:'media',label:'Media',icon:Film},{id:'connectors',label:'Connectors',icon:Plug},{id:'settings',label:'Settings',icon:Settings2}
];
